export const exhibitions = [
  ...
  },
  {
    ...
    description: "Digital art is an artistic work or practice that uses digital technology as an essential part of the creative or presentation process. Digital art is an artistic work or practice that uses digital technology as an essential part of the creative or presentation process."
  },
  {
    id: 3,
    ...
    description: "Abstract art uses a visual language of shape, form, color and line to create a composition which may exist with a degree of independence from visual references in the world. Abstract art uses a visual language of shape, form, color and line to create a composition which may exist with a degree of independence from visual references in the world."
  },
  {
    id: 4,
    title: "Light & Shadow",
  ...
  },
  {
    ...
    description: "Urban art is a style of art that relates to cities and city life often done by artists who live in or have a passion for city life. Urban art is a style of art that relates to cities and city life often done by artists who live in or have a passion for city life"
  }
];
